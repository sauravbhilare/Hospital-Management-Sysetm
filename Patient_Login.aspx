<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Patient_Login.aspx.cs" Inherits="Patient_Patient_Login" %>
                        ...
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form class="mt-5 mb-5 login-input" runat="server">
                                    ...
                                    <asp:Button ID="btnlogin" runat="server" CssClass="btn login-form__btn submit w-100" Text="Login" OnClick="btnlogin_Click" ValidationGroup="valid" />

                                    <!-- New user registration link -->
                                    <div class="mt-3">
                                        <p>New User? <a href="Patient/Registration.aspx" style="color:blue;">Register here</a></p>
                                    </div>
                                </form>
                            </div>
