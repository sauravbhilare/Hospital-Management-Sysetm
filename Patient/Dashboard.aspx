<%@ Page Title="" Language="C#" MasterPageFile="~/Patient/PatientMaster.master" AutoEventWireup="true" CodeFile="Dashboard.aspx.cs" Inherits="Patient_Dashboard" %>
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-6">
                <div class="card gradient-1">
                    <div class="card-body">
                        <h3 class="card-title text-white">Today's Appointment</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">
                                <asp:Label ID="todayapp" runat="server">0</asp:Label></h2>
                        </div>
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="card gradient-2">
                    <div class="card-body">
                        ...
                        <div class="d-inline-block">
                            <h2 class="text-white">
                                <asp:Label ID="lblapp" runat="server">0</asp:Label></h2>
                        </div>
