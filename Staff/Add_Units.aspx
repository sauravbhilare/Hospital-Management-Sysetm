<%@ Page Title="" Language="C#" MasterPageFile="~/Staff/StaffMaster.master" AutoEventWireup="true" CodeFile="Add_Units.aspx.cs" Inherits="Staff_Add_Units" EnableEventValidation="false" %>
                    ...
                    <div class="card-body">
                            ...
                            <div class="basic-form">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <asp:TextBox ID="txtunit" runat="server" class="form-control" placeholder="Unit" required></asp:TextBox>
                                    </div>
                                    <div class="form-group col-md-6">
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvProductType" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered zero-configuration"
                                ...
                                DataKeyNames="Unit_Id" AllowPaging="false" PageSize="20" BackColor="White" BorderColor="#DEDFDE"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Product Id" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblMasterId" runat="server" Text='<%# Eval("Unit_Id")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Product Type">
                                        <ItemTemplate>
                                            <asp:Label ID="lbltype" runat="server" Text='<%# Eval("Unit_Name")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Opration">
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete1" CommandArgument='<%# Eval("Unit_Id")%>'>
