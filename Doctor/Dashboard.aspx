<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/DoctorMaster.master" AutoEventWireup="true" CodeFile="Dashboard.aspx.cs" Inherits="Doctor_Dashboard" %>
    ...
    <div class="container-fluid mt-3">
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-1" style="height: 155px">
                    <div class="card-body">
                        <h3 class="card-title text-white">Today's Appoinments</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">
                                <asp:Label ID="ttltdapp" runat="server">0</asp:Label></h2>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-2" style="height: 155px">
                    <div class="card-body">
                        <h3 class="card-title text-white">Total Appointments</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">
                                <asp:Label ID="lbltapp" runat="server">0</asp:Label></h2>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-3" style="height: 155px">
                    <div class="card-body">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-4">
                    <div class="card-body">
                        <h3 class="card-title text-white">Total Fees</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">
                                <asp:Label ID="ttlfees" runat="server">0</asp:Label></h2>
                            <p class="text-white mb-0">Today's -<asp:Label ID="todaytotalfees" runat="server">0</asp:Label></p>
                        </div>
