<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Admin/Master_Admin.master" AutoEventWireup="true" CodeFile="Doctors_Registration.aspx.cs" Inherits="Master_Admin_Doctors_Registration" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Label ID="lblcertificate1" runat="server" Visible="false"></asp:Label>
    <asp:Label ID="lblcertificate2" runat="server" Visible="false"></asp:Label>
    <asp:Label ID="lblcertificate3" runat="server" Visible="false"></asp:Label>
    <asp:Label ID="lblpan" runat="server" Visible="false"></asp:Label>
    <asp:Label ID="lblaadhar" runat="server" Visible="false"></asp:Label>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">Doctors Registration</h3>
                        <form>
                            <div class="basic-form">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                     ...
                                     <div class="form-group col-md-4">
                                        <label>DOB</label>
                                        <asp:TextBox ID="txtdob" runat="server" class="form-control" placeholder="DD/MM/YYYY" TextMode="date"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-md-4">
                            ...
                            <div class="basic-form">
                                <h5 class="fs-title">Qualification Details</h5>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <asp:FileUpload ID="file2" runat="server" class="form-control" />
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Certificate 3</label>
                                        <asp:FileUpload ID="file3" runat="server" class="form-control" />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Specilization <span style="color: red">*</span></label>
                                        <asp:TextBox ID="txtspecilization" runat="server" class="form-control" placeholder="Specilization" required></asp:TextBox>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Experience <span style="color: red">*</span></label>
                                        <asp:TextBox ID="txtexperiance" runat="server" class="form-control" placeholder="Experience" required></asp:TextBox>
                                    </div>
                                </div>
                            </div>

                            <div class="basic-form">
                                <h5 class="fs-title">Documents Details</h5>
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <asp:FileUpload ID="panfile" runat="server" class="form-control" required />
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Aadhar No <span style="color: red">*</span></label>
                                        <asp:TextBox ID="txtaadhar" runat="server" class="form-control" placeholder="Aadhar No" required></asp:TextBox>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Aadhar Card <span style="color: red">*</span></label>
                                        <asp:FileUpload ID="fileaadhar" runat="server" class="form-control" required />
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Photo</label>
