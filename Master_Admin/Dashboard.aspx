<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Admin/Master_Admin.master" AutoEventWireup="true" CodeFile="Dashboard.aspx.cs" Inherits="Master_Admin_Dashboard" %>
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-1" style="height:155px">
                    <div class="card-body">
                        <h3 class="card-title text-white">Total Staff</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">
                                <asp:Label ID="ttlstaff" runat="server">0</asp:Label></h2>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-4">
                    <div class="card-body">
                        <h3 class="card-title text-white">Total Collection</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">
                                <asp:Label ID="lbltotal" runat="server">0</asp:Label></h2>
                            <p class="text-white mb-0">Today's -<asp:Label ID="todaytotal" runat="server">0</asp:Label></p>
                        </div>
