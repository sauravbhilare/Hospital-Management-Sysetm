<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Admin/Master_Admin.master" AutoEventWireup="true" CodeFile="Master_Admin_Registration.aspx.cs" Inherits="Master_Admin_Staff_Registration" EnableEventValidation="false" %>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Master Admin Registration</h4>
