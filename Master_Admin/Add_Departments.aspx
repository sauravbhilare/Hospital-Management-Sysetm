<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Admin/Master_Admin.master" AutoEventWireup="true" CodeFile="Add_Departments.aspx.cs" Inherits="Master_Admin_Add_Departments" EnableEventValidation="false" %>
                    ...
                    <div class="card-body">
                            ...
                            <div class="basic-form">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <asp:TextBox ID="txtdepartment" runat="server" class="form-control" placeholder="Department" required></asp:TextBox>
                                    </div>
                                    <div class="form-group col-md-6">
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvProductType" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered zero-configuration"
                                ...
                                DataKeyNames="Department_Id" AllowPaging="false" PageSize="20" BackColor="White" BorderColor="#DEDFDE"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Product Id" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblMasterId" runat="server" Text='<%# Eval("Department_Id")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Product Type">
                                        <ItemTemplate>
                                            <asp:Label ID="lbltype" runat="server" Text='<%# Eval("Department_Name")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Opration">
                                        <ItemTemplate>
                                            <%--<asp:LinkButton ID="lnkUpdate" runat="server" CommandName="Update" CommandArgument='<%# Eval("Department_Id")%>'>
                                             <img src="../icons/user_Edit.png" alt="Edit" width="25" height="25" />
                                            </asp:LinkButton>--%>
                                            <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete1" CommandArgument='<%# Eval("Department_Id")%>'>
